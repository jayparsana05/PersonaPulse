...
Usage:
    ...
    python test_research.py "AWS serverless and generative AI"
    python test_research.py "latest open source LLM benchmarks"
"""

import time
import sys
import json
from src.ingestion import fetch_trending_tech_news, extract_og_image
from src.memory import get_style_profile
from src.llm import draft_post

def test_research(query: str = "latest AI and machine learning breakthroughs"):
    print("\n" + "=" * 65)
    ...
    try:
        article = fetch_trending_tech_news(query)
...
if __name__ == "__main__":
    search_query = sys.argv[1] if len(sys.argv) > 1 else "latest AI and machine learning breakthroughs"
